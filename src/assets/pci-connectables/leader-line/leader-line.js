...
var LeaderLine = (function () {
  ...
  function newDropShadow(document, id) {
    ...
    dropShadow.elmsAppend = [
      (dropShadow.elmFilter = filter = document.createElementNS(
        SVG_NS,
        "filter"
      )),
    ];
    ...
    if (svg2SupportedDropShadow) {
      dropShadow.elmOffset = dropShadow.elmBlur = element = filter.appendChild(
        document.createElementNS(SVG_NS, "feDropShadow")
      );
  ...
  function bindWindow(props, newWindow) {
    ...
    svg.className.baseVal =
      APP_ID +
      " " +
      props.options.containerID +
      " " +
      props.options.uniqueLineID;
  ...
  function updatePlug(props) {
    ...
    [0, 1].forEach(function (i) {
      ...
      curStats.plugOutline_plugSE[i] = curStats.capsMaskMarker_plugSE[
        i
      ] = plugId;
        ...
        if (curStats.plug_enabledSE[i]) {
          ...
          if (curStats.plugOutline_enabledSE[i]) {
            if (
              ...
              props.plugOutlineFaceSE[i].href.baseVal = props.plugMaskShapeSE[
                i
              ].href.baseVal = props.plugOutlineMaskShapeSE[i].href.baseVal =
                "#" + symbolConf.elmId;
        ...
        case PATH_MAGNET:
          /* @EXPORT[file:../test/spec/func/PATH_FLUID]@ */ (function (
            ...
            /* @/EXPORT@ */ [
              ...
              curStats.position_path === PATH_MAGNET
                ? 0
                : curSocketGravitySE[1],
            ]
          );
          break;
      ...
      (function () {
        ...
        curStats.position_plugOverheadSE.forEach(function (plugOverhead, i) {
          ...
          if (plugOverhead > 0) {
            ...
            minAdjustOffset = -anchorBBoxSE[i][
              axis === "x" ? "width" : "height"
            ];
  ...
  function updateViewBox(props) {
    ...
    curBBox.x = curStats.lineMask_x = curStats.lineOutlineMask_x = curStats.maskBGRect_x =
      edge.x1;
    curBBox.y = curStats.lineMask_y = curStats.lineOutlineMask_y = curStats.maskBGRect_y =
      edge.y1;
  ...
  function updateMask(props) {
    ...
    if (curStats.lineMask_enabled) {
      ...
      if (
        ...
        props.lineMaskCaps.style.display = props.lineOutlineMaskCaps.style.display = value
          ? "inline"
          : "none";
        updated = true;
        if (IS_WEBKIT) {
        ...
        [0, 1].forEach(function (i) {
          ...
          ["x", "y"].forEach(function (pointKey) {
            if (
              ...
              props.efc_gradient_gradient[
                pointKey + (i + 1)
              ].baseVal.value = aplStats.gradient_pointSE[i][pointKey] = value;
            }
          });
        });
        traceLog.add("</EFFECTS.gradient.update>"); // [DEBUG/]
    ...
    dropShadow: {
      ...
      remove: function (props) {
        ...
        if (props.efc_dropShadow_elmsAppend) {
          ...
          props.efc_dropShadow_elmFilter = props.efc_dropShadow_elmOffset = props.efc_dropShadow_elmBlur = props.efc_dropShadow_styleFlood = props.efc_dropShadow_elmsAppend = null;
        }
  ...
  function LeaderLine(start, end, options) {
    var props = {
      ...
      options: {
        ...
        uniqueLineID: options.uniqueLineID,
      },
      optionIsAttach: {
  ...
  ATTACHMENTS = {
    ...
    mouseHoverAnchor: {
      ...
      init: function (attachProps, attachOptions) {
        ...
        curStyle = attachProps.element.ownerDocument.defaultView.getComputedStyle(
          attachProps.element,
          ""
        );
        // display
